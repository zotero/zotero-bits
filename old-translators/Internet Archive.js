{
        ...
        "inRepository": true,
        "translatorType": 4,
        "lastUpdated": "2011-05-22 01:20:25"
}
...
function scrape(doc, url) {
	...
	if (mediaType1 == "commons") {
		...
		if (doc.evaluate('//p[@class="content"]/span[@class="key"][1]', doc, nsResolver, XPathResult.ANY_TYPE, null).iterateNext()) {
			var headers = doc.evaluate('//p[@class="content"]/span[@class="key"]', doc, nsResolver, XPathResult.ANY_TYPE, null);
			var contents = doc.evaluate('//p[@class="content"]/span[@class="value"]', doc, nsResolver, XPathResult.ANY_TYPE, null);
