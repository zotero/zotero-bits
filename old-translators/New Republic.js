{
        "translatorID": "a81d90d8-4adb-42d8-a889-46ceaa0c0148",
        "label": "New Republic",
        "creator": "Sebastian Karcher",
        "target": "^https?://(?:www\\.)?tnr\\.com",
        "minVersion": "1.0",
        "maxVersion": "",
        "priority": 100,
        "inRepository": true,
        "translatorType": 4,
        "lastUpdated": "2011-06-16 12:44:13"
}
...
detect           : FW.Url().match(/\/article/),
title            : FW.Xpath('//div[@class="entry_header clearfix"]/h1').text().trim(),
attachments      : [{ url: FW.Url().replace(/tnr\.com/,"tnr.com/print"),
  title:  "TNR Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//ul[@class="detail_top_links"]/li/div[@class="author" and not(.//h3)] | //ul[@class="detail_top_links"]/li/div[@class="author"]//h3 ').text().cleanAuthor("author"),
date             : FW.Xpath('//ul[@class="detail_top_links"]/li[@class="post_date"]').text().remove(/\|.*/).trim(),
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Url().match(/\/blog/),
title            : FW.Xpath('//div[@class="entry_header clearfix"]/h1').text().trim(),
attachments      : [{ url: FW.Url().replace(/tnr\.com/,"tnr.com/print"),
  title:  "TNR Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//ul[@class="detail_top_links"]/li/div[@class="author"]//h3').text().cleanAuthor("author"),
date             : FW.Xpath('//ul[@class="detail_top_links"]/li[@class="post_date"]').text().remove(/\|.*/).trim(),
tags             : FW.Xpath('//div[@id="tags"]/a').text(),
publicationTitle : "The New Republic"
});
...
choices          : {
  titles :  FW.Xpath('//div[@class="entry_title"]/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="entry_title"]/a').key("href")
}
});
...
var testCases = [
    {
        "type": "web",
        "url": "http://www.tnr.com/article/politics/89908/gop-debate-new-hampshire-mitt-romney",
        "items": [
            {
                "itemType": "magazineArticle",
                "creators": [
                ...
                "attachments": [
                    {
                        "url": "http://www.tnr.com/print/article/politics/89908/gop-debate-new-hampshire-mitt-romney",
                        "title": "TNR Snapshot",
                        "type": "text/html"
                    }
                ],
                ...
                "date": "June 14, 2011",
                "publicationTitle": "The New Republic",
                "title": "The New Hampshire Debate: Who Can Catch Mitt?",
                "libraryCatalog": "New Republic",
                "accessDate": "CURRENT_TIMESTAMP",
                "shortTitle": "The New Hampshire Debate"
            }
        ]
    },
    {
        "type": "web",
        "url": "http://www.tnr.com/article/politics/89992/mitt-romney-conservatives-freedomworks-campaign",
        "items": [
            {
                "itemType": "magazineArticle",
                "creators": [
                ...
                "attachments": [
                    {
                        "url": "http://www.tnr.com/print/article/politics/89992/mitt-romney-conservatives-freedomworks-campaign",
                        "title": "TNR Snapshot",
                        "type": "text/html"
                    }
                ],
                ...
                "date": "June 15, 2011",
                "publicationTitle": "The New Republic",
                "title": "Mitt Romney: The Campaign Within the Conservative Movement to Take Him Down",
                "libraryCatalog": "New Republic",
                "accessDate": "CURRENT_TIMESTAMP",
                "shortTitle": "Mitt Romney"
            }
        ]
    },
    {
        "type": "web",
        "url": "http://www.tnr.com/blog/jonathan-cohn/90064/our-political-insanity-in-two-paragraphs",
        "items": [
            {
                "itemType": "blogPost",
                "creators": [
                ...
                "attachments": [
                    {
                        "url": "http://www.tnr.com/print/blog/jonathan-cohn/90064/our-political-insanity-in-two-paragraphs",
                        "title": "TNR Snapshot",
                        "type": "text/html"
                    }
                ],
                ...
                "date": "June 15, 2011",
                "publicationTitle": "The New Republic",
                "title": "Our Political Insanity, in Two Paragraphs",
                "libraryCatalog": "New Republic",
                "accessDate": "CURRENT_TIMESTAMP"
            }
        ]
