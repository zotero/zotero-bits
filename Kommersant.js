...
FW.Scraper({ itemType         : 'magazineArticle',
             detect           : FW.Xpath('//div[@class="issue"]/a[contains(text(),"Журнал")]'),
             ...
             date             : FW.Xpath('//div[@class="issue"]/a').text().replace(/.*(\d{2})\.(\d{2})\.(\d{4})\s*$/,"$3-$2-$1"),
             issue            : FW.Xpath('//div[@class="issue"]/a').text().match(/№\s*(\d+(?: \(\d+\))?)/,1),
             abstractNote     : FW.Xpath('//div[@class="document_vvodka"]').text().trimInternal(),
             publicationTitle : FW.Xpath('//div[@class="issue"]/a').text().match(/^\s*Журнал\s+"([^"]+)"/,1)
});

/** News Articles */
FW.Scraper({ itemType         : 'newspaperArticle',
             detect           : FW.Xpath('//div[@class="issue"]/a[contains(text(),"Газета") or contains(text(),"Online")]'),
             title            : FW.Xpath('//div[@class="document"]/div[@class="title"]').text().trim(),
             attachments      : [
             { 
	             url : FW.Url(),
	      ...
	      creators         : FW.Xpath('//div[contains(@class, "document_authors")][preceding-sibling::div[@class="document_vvodka"]]')
             ...
             date             : FW.Xpath('//div[@class="issue"]/a').text().replace(/.*(\d{2})\.(\d{2})\.(\d{4})\s*(?:\/\/\s\d+:\d+)?$/,"$3-$2-$1"),
             issue            : FW.Xpath('//div[@class="issue"]/a').text().match(/№\s*(\d+(?: \(\d+\))?)/,1),
             abstractNote     : FW.Xpath('//div[@class="document_vvodka"]').text().trimInternal(),
             publicationTitle : FW.Xpath('//div[@class="issue"]/a').text().match(/^\s*"([^"]+)"/,1)
});
