{
        ...
        "target": "^https?://library\\.hcc\\.govt\\.nz",
        "minVersion": "1.0",
        "maxVersion": "",
        "priority": 100,
        "inRepository": "1",
...
function scrape ( doc, url) {
	...
	// This is not a canonical URL, so we add a link and don't set item.url
	newItem.attachments.push({title:"Hamilton Library Record", snapshot:false, mimeType:"text/html", url:doc.location.href});
	newItem.complete();
}
